...
- **CP10**: Annual report handoff checklist complete — ready for `/artifi-ee:prepare-annual-report`
...
- "To generate the annual report and XBRL files for filing at ariregister.rik.ee, run: `/artifi-ee:prepare-annual-report`"
- If they also need VAT declarations: "For VAT declarations, use: `/artifi-ee-vat:prepare-vat-declaration`"
