...
Before running the annual report plugin (`/artifi-ee:prepare-annual-report`), verify all items below. Each maps to a checkpoint in the annual report plugin.
...
1. Run: `/artifi-ee:prepare-annual-report`
...
- **VAT declarations**: `/artifi-ee-vat:prepare-vat-declaration` — for monthly/quarterly KMD filing
- **Payroll**: `/artifi-ee-payroll:calculate-payroll` — for TSD declarations
